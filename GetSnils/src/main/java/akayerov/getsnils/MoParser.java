    ...
    public Parser pmo[] =
    	{
    	  ...
    	  new Parser("УГЛИЧ","ЦРБ","",UGL_CRB),
    	  new Parser("ЯРОСЛАВСКАЯ","ЦРБ","",YAR_CRB),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№2", KB2),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№3", KB3),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№5", KB5),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№8", KB8),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№9", KB9),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№10", KB10),
    	  new Parser("КЛИНИЧЕСКАЯ"," Б","№1", KB1),
